                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row" >
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body">
                                                <center><p class="card-title mb-0" style="font-size: 30px">Delivery Agent Activations</p></center>
                                                <br>
                                                <br>
                                                    ...
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ResultSet rs = st.executeQuery("Select * from delagent where astatus='No' order by id DESC");
                                                                    while (rs.next()) {

                                                            %>
                                                            <tr>
                                                                <td ><%=rs.getString("id")%></td>
                                                                <td ><img src="agentpic.jsp?uid=<%=rs.getString("id")%>" width="80px" height="80px" ></td>
                                                                <td ><%=rs.getString("aname")%></td>
                                                                <td ><%=rs.getString("afname")%></td>
                                                                <td ><%=rs.getString("adob")%></td>
                                                                <td ><%=rs.getString("agender")%></td>
                                                                <td ><%=rs.getString("amail")%></td>
                                                                <td ><%=rs.getString("aphone")%></td>
                                                                <td ><%=rs.getString("acity")%></td>
                                                                <td class="font-weight-bold"><%=rs.getString("astatus")%></td>
                                                                <td><a href="ActivateDA?id=<%=rs.getString("id")%>" class="btn btn-group-lg btn-success" >Activate</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="rejectDA?id=<%=rs.getString("id")%>" class="btn btn-group-lg btn-danger" >Reject</a></td>
                                                                <%                                        }
                                                                        rs.close();
                                                                        con.close();
                                                                    } catch (Exception ex) {
