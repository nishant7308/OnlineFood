                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row" >
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body">
                                                <center><p class="card-title mb-0" style="font-size: 30px">Users List</p></center>
                                                <br>
                                                <br>
                                                <div class="table-responsive" >
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            %>
                                                            <tr>
                                                                <td class="font-weight-bold"><%=rs.getString("id")%></td>
                                                                <td ><%=rs.getString("name")%></td>
                                                                <td class="font-weight-bold"><%=rs.getString("mailid")%></td>
                                                                <td class="font-weight-bold"><%=rs.getString("phone")%></td>
