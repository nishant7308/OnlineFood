        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar" >
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="DAHome.jsp">
                                <i class="icon-grid menu-icon"></i>
                                <span class="menu-title">Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="DAOrders.jsp">
                                <i class="ti-user menu-icon"></i>
                                <span class="menu-title">Orders</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="DAhistory.jsp">
                                <i class="ti-user menu-icon"></i>
                                <span class="menu-title">Delivery History</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="DAcomp.jsp">
                                <i class="ti-user menu-icon"></i>
                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row" >
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body">
                                                <center><p class="card-title mb-0" style="font-size: 30px"><%=session.getAttribute("dname").toString()%> Orders</p></center>
                                                <br>
                                                <br>
                                                <div class="table-responsive" >
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                String dcity = session.getAttribute("dcity").toString();
                                                                System.out.println("className.methodName()"+dcity);
                                                                Connection con = SQLconnection.getconnection();
                                                                Statement st = con.createStatement();
                                                                try {
                                                                    ResultSet rs = st.executeQuery("Select * from useroders where city='" + dcity + "' and orderstatus='Confirmed' and dastatus='Waiting' order by id DESC");
                                                                    while (rs.next()) {
                                                            %>
                                                            <tr>
                                                                ...
                                                                <td class="font-weight-bold"><a href="DAorderAccept?id=<%=rs.getString("id")%>&oid=<%=rs.getString("oid")%>" class="btn btn-group-lg btn-success" >confirm</a></td>
                                                                <%                                        }
                                                                        rs.close();
                                                                        con.close();
                                                                    } catch (Exception ex) {
