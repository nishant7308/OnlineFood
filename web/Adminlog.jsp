...
<body class="align">
    ...
    <h3 style="font-size: 30px;">Admin</h3>
    <div class="grid" style="margin-bottom: 200px">
    <form action="adminlog" method="POST" class="form login">

      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Username</span></label>
        <input autocomplete="username" id="login__username" type="text" name="name" class="form__input" placeholder="Username" required>
      </div>
