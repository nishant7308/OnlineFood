                                                    ...
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ResultSet rs = st.executeQuery("Select * from useroders where resid='"+rid+"' and orderstatus='waiting' order by id DESC");
                                                                    while (rs.next()) {
                                                            %>
                                                            <tr>
                                                                ...
                                                                <td class="font-weight-bold"><a href="orderaccept?id=<%=rs.getString("id")%>&oid=<%=rs.getString("oid")%>" class="btn btn-group-lg btn-success" >confirm</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="orderreject?id=<%=rs.getString("id")%>" class="btn btn-group-lg btn-danger" >Reject</a></td>
                                                                <%                                        }
                                                                        rs.close();
                                                                        con.close();
                                                                    } catch (Exception ex) {
