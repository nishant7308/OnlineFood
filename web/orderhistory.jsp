                                    ...
                                    <td valign="top" align="center">
                                        <table class="table600" width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="border-collapse: collapse; text-align: left;">
                                            ...
                                            <tr>
                                                <td valign="top" style="font-size: 18px; line-height: 1;">
                                                    <span>
                                                        Your Order ID is <a style="color: #ff00cc;"><%=rs.getString("oid")%></a><br><br>
                                                        <a href="userFeedback.jsp?oid=<%=rs.getString("oid")%>&resid=<%=rs.getString("resid")%>"><b>Click here For Feedback</b></a> &nbsp;&nbsp;&nbsp;&nbsp; <a style="color: #F89880;" href="">Order Status: <b><%=rs.getString("orderstatus")%></b></a>
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
