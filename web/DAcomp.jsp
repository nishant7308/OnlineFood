                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row" >
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body">
                                                <center><p class="card-title mb-0" style="font-size: 30px"><%=session.getAttribute("dname").toString()%> Delivery Feedbacks</p></center>
                                                <br>
                                                <br>
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ...
                                                                    ResultSet rs = st1.executeQuery("Select * from feedback where oid='"+OID+"' order by id DESC");
                                                                    while (rs.next()) {
                                                            %>
                                                            <tr>
